...
void reactToInput(GLFWwindow* window, int* keyX, int* keyY, float* lookX, float* lookY)
{
...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(screenWidth, screenHeight, "raymarching-opengl", NULL, NULL);
    if (window == NULL)
    {
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        reactToInput(window, &keyX, &keyY, &lookX, &lookY);
